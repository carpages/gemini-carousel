( function( factory ) {
  ...
  this['Templates']['Default']['Carousel'] =
    this['Templates']['Default']['Carousel'] || {};

  this['Templates']['Default']['Carousel']['nav'] = Handlebars.template({
    compiler: [ 7, '>= 4.0.0' ],
    main: function( container, depth0, helpers, partials, data ) {
      var helper;

      return (
        '<ol class="carousel__nav pagination pagination--carousel">\n\n 	<li class="pagination__prev"><a href="#" data-goto="--">Previous</a></li>\n\n	<li class="pagination__item">\n		<span class="carousel__current-page-count">1</span>\n		/\n		<span class="carousel__page-count">' +
        container.escapeExpression(
          (
            ( helper =
              ( helper =
                helpers.pageCount ||
                ( depth0 != null ? depth0.pageCount : depth0 )) != null
                ? helper
